...
class DNSSEC implements API {
    ...
    function get(string $zoneID): stdClass {
     ...
     */
    function enable(string $zoneID): stdClass {
     ...
     * @return stdClass DNSSEC data for the domain
     */
    function disable(string $zoneID): stdClass {
     ...
     */
    function getStatus(string $zoneID):string {
     ...
     */
    function getDS(string $zoneID):string {
        $sec=$this->get($zoneID);
        if((string)@$sec->digest=='') return '';
